...
/// App Colors
class AppColors {
  static const Color primaryBlue = Color(0xFF0063F7);
  static const Color backgroundColor = Color(0xFFF8FAFC);
  static const Color textDark = Color(0xFF1D232C);
  static const Color textGray = Color(0xFF8391A1);
  static const Color successGreen = Color(0xFF21BF73);
  static const Color successGreenLight = Color(0xFFE1F7E9);
  static const Color errorRed = Color(0xFFFF5A5A);
  static const Color errorRedLight = Color(0xFFFFECEB);
...
class AppStrings {
  ...
  static const String securityFeaturesVerified = 'Security Features Verified';
  static const String saveToHistory = 'Save to History';
  static const String scanHistory = 'Scan History';
  static const String authentic = 'Authentic';
